...
import com.astroguider.astro.coords.Precession
...
object PlanetEphemeris {
     ...
     *  defined in. Callers combine this with [com.astroguider.astro.coords.Precession] to get
    ...
    fun geocentricEquatorialJ2000(body: SolarSystemBody, julianCenturiesJ2000: Double): EquatorialCoordinates {
        ...
        return Ecliptic.toEquatorial(
            com.astroguider.astro.coords.EclipticCoordinates(longitude, latitude),
            obliquityJ2000,
        )
    }
